function setItems(item,price)
{
  ...
  var  js={
      ...
      if(!localStorage.getItem("details")){
        ...
        let session=JSON.parse(localStorage.getItem('details'))
...
function addBlock()
{
  let item:any=document.getElementById('item').innerHTML;
  let price:any=document.getElementById('price').innerHTML;
  console.log("kp");
  console.log(item);
  console.log(price);
  alert("Item Added");
